...
const ChatContainer = () => {
        ...
        const { messages,selectedUsers,setselectedUsers,sendMessages,getMessages  } = useContext(ChatContext)
  ...
  return selectedUsers ? (
    ...
    <div className='h-full overflow-scroll relative backdrop-blur-lg'>
      ...
      <div className='flex items-center gap-3 py-3 mx-4 border-b border-stone-500'>
            ...
            <img onClick={ ()=> setselectedUsers(null) } src={assets.arrow_icon} alt="" 
            ...
            ? 'flex-row-reverse' : ''}`}>
              ...
              <div className='text-center text-xs'>
                <img src={msg.senderId === authUser._id ? 
                  authUser?.profilePic || assets.avatar_icon : selectedUsers?.profilePic || assets.avatar_icon } alt="" className='w-7 rounded-full'/>
